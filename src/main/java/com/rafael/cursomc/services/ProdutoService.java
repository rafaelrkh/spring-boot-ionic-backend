...
public class ProdutoService {
	...
	public Produtos find(Integer cd_produto){
		  Optional<Produtos> obj  = rep.findById(cd_produto);
		  
		  if(obj == null) {
			 throw new ObjectNotFoundException("Objeto não encontrado! Código: " + cd_produto +
