...
public class Pedidos implements Serializable{
	...
	public String toString() {
		...
		builder.append(getCd_pedido());
		builder.append(", Data: ");
		builder.append(sdf.format(getDt_pedido()));
		builder.append(", Cliente: ");
		builder.append(getCliente().getDs_nome());
		builder.append(", Situação do pagamento: ");
		builder.append(getPagamento().getEstado_pagamento().getDsEstadoPagamento());
		builder.append("\n Detalhes: \n");
